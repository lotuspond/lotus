...
vnoremap  <buffer>  <silent>  <Leader>sw      <Esc>:call BASH_FlowControl( "while _ ",     "do",   "done",     "v" )<CR>
 ...
 noremap  <buffer>  <silent>  <Leader>sz           :call BASH_FlowControl( "if test $? -ne 0 ",     "then",   "fi",     "a" )<CR>o
inoremap  <buffer>  <silent>  <Leader>sz      <Esc>:call BASH_FlowControl( "if test $? -ne 0 ",     "then",   "fi",     "a" )<CR>o
vnoremap  <buffer>  <silent>  <Leader>sz      <Esc>:call BASH_FlowControl( "if test $? -ne 0 ",     "then",   "fi",     "a" )<CR>
