...
"Lotus setting 081112
  nnoremap    <buffer>  <silent>  <Leader>jp    aprintf "\n";<Left><Left><Left><Left>
  inoremap    <buffer>  <silent>  <Leader>jp    printf "\n";<Left><Left><Left><Left>
 
  nnoremap    <buffer>  <silent>  <Leader>jo    aopen my $F, "<" or die "$0 open fail:$!";<Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left>
  inoremap    <buffer>  <silent>  <Leader>jo    open my $F, "<" or die "$0 open fail:$!";<Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left>
 
  nnoremap    <buffer>  <silent>  <Leader>jc    aclose $ or die "$0 close fail: $!";<Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left>
  inoremap    <buffer>  <silent>  <Leader>jc    close $ or die "$0 close fail: $!";<Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left>
  
  
  nnoremap    <buffer>  <silent>  <LocalLeader>jd              :call Perl_InsertTemplate("statements.do-while")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>jf              :call Perl_InsertTemplate("statements.for")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>jfe             :call Perl_InsertTemplate("statements.foreach")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>ji              :call Perl_InsertTemplate("statements.if")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>jie             :call Perl_InsertTemplate("statements.if-else")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>je              :call Perl_InsertTemplate("statements.else")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>jei             :call Perl_InsertTemplate("statements.elsif")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>ju              :call Perl_InsertTemplate("statements.unless")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>jue             :call Perl_InsertTemplate("statements.unless-else")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>jt              :call Perl_InsertTemplate("statements.until")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>jw              :call Perl_InsertTemplate("statements.while")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>j{              :call Perl_InsertTemplate("statements.block")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>jb              :call Perl_InsertTemplate("statements.block")<CR>
  nnoremap    <buffer>  <silent>  <LocalLeader>ja              :call Perl_InsertTemplate("statements.aif")<CR>

  vnoremap    <buffer>  <silent>  <LocalLeader>jd    <C-C>:call Perl_InsertTemplate("statements.do-while", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>jf    <C-C>:call Perl_InsertTemplate("statements.for", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>jfe   <C-C>:call Perl_InsertTemplate("statements.foreach", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>ji    <C-C>:call Perl_InsertTemplate("statements.if", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>jie   <C-C>:call Perl_InsertTemplate("statements.if-else", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>je    <C-C>:call Perl_InsertTemplate("statements.else", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>jei   <C-C>:call Perl_InsertTemplate("statements.elsif", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>ju    <C-C>:call Perl_InsertTemplate("statements.unless", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>jue   <C-C>:call Perl_InsertTemplate("statements.unless-else", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>jt    <C-C>:call Perl_InsertTemplate("statements.until", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>jw    <C-C>:call Perl_InsertTemplate("statements.while", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>j{    <C-C>:call Perl_InsertTemplate("statements.block", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>jb    <C-C>:call Perl_InsertTemplate("statements.block", "v" )<CR>
  vnoremap    <buffer>  <silent>  <LocalLeader>ja    <C-C>:call Perl_InsertTemplate("statements.aif", "v" )<CR>

  inoremap    <buffer>  <silent>  <LocalLeader>jd    <C-C>:call Perl_InsertTemplate("statements.do-while")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>jf    <C-C>:call Perl_InsertTemplate("statements.for")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>jfe   <C-C>:call Perl_InsertTemplate("statements.foreach")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>ji    <C-C>:call Perl_InsertTemplate("statements.if")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>jie   <C-C>:call Perl_InsertTemplate("statements.if-else")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>je    <C-C>:call Perl_InsertTemplate("statements.else")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>jei   <C-C>:call Perl_InsertTemplate("statements.elsif")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>ju    <C-C>:call Perl_InsertTemplate("statements.unless")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>jue   <C-C>:call Perl_InsertTemplate("statements.unless-else")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>jt    <C-C>:call Perl_InsertTemplate("statements.until")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>jw    <C-C>:call Perl_InsertTemplate("statements.while")<CR>
  inoremap    <buffer>  <silent>  <LocalLeader>ja    <C-C>:call Perl_InsertTemplate("statements.aif")<CR>
